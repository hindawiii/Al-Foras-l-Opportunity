...
export const FeaturesVisualInfographic = ({ onNavigate }: VisualInfographicProps) => {
  ...
  const nodes = [
    ...
    },
    {
      ...
      num: 2,
      icon: GraduationCap,
      badgeAr: "دليل أكاديمي 20+ دولة",
      badgeEn: "20+ Arab Nations",
      titleAr: "أركان ودليل الجامعات العربية",
      titleEn: "Arab Universities & Country Hubs",
      descAr: "تغطية شاملة لأكثر من 20 دولة عربية (وفي مقدمتها السودان 🇸🇩) تشمل الجامعات الحكومية والخاصة ونسب القبول والرسوم والمنح المتاحة.",
      descEn: "Comprehensive coverage of 20+ Arab countries (featuring Sudan 🇸🇩 first), public/private universities, acceptance rates, and fees.",
      statAr: "20+ دولة عربية",
      statEn: "20+ Countries",
