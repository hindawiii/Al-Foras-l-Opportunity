...
const STRINGS: Record<Lang, Record<string, string>> = {
  ar: {
    ...
    jobOpportunitiesSub: "موقع · فريلانسر · وظائف ·",
    discover: "اكتشف",
    ...
    landingFeature2Body: "لاستكشاف الجامعات الحكومية والخاصة عبر 8 دولة عربية مع مطابقة المؤهلات ونسب القبول.",
    ...
    landingArabHubSubtitle: "استكشف الجامعات والمؤسسات المعتمدة عبر 8 دولة عربية مع نسب القبول والمنح",
  ...
  en: {
    ...
    jobOpportunitiesSub: "Platforms · Freelance · Jobs ·",
    discover: "Discover",
    ...
    landingFeature2Body: "Explore public and private universities across 8 Arab nations with intelligent matching for qualifications and admission criteria.",
    ...
    landingArabHubSubtitle: "Explore accredited institutions across 8 Arab nations with admission criteria and scholarships",
